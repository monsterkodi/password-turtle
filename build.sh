...
node_modules/electron-packager/cli.js . password-turtle --platform=darwin --arch=x64 --prune --version=0.33.6 --app-version=::package.json:version:: --app-bundle-id=net.monsterkodi.password-turtle --icon=img/turtle.icns
